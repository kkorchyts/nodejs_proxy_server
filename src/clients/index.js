...
export const nasaGetAsteroidsClient = (param) => axiosNasaClient(buildGetAsteroidsRequest(param), nasaAsteroidsResponseSchema);
export const nasaGetPhotosManifestClient = (param) => axiosNasaClient(buildGetManifestRequest(param), nasaManifestResponseSchema);
export const nasaGetPhotosClient = (param) => axiosNasaClient(buildGetPhotosRequest(param), nasaRoverPhotosResponseSchema);
